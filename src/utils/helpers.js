...
export function getStatusBadgeClass(status) {
  switch (status) {
    ...
    case 'Rates Available':return 'badge badge-available';
    case 'Quoted':return 'badge badge-quoted';
    case 'Confirmed':return 'badge badge-confirmed';
    case 'SLA Breached':return 'badge badge-breached';
    case 'No Rate':return 'badge badge-norate';
